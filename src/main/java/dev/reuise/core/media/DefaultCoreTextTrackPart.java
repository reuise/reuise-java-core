...
public abstract class DefaultCoreTextTrackPart<S extends DefaultCoreTextTrackPart<S, O>, O extends CoreTextTrackPartOptions> implements ComponentPart , CoreTextTrack {
    @Override
    ...
    protected DefaultCoreTextTrackPart(O options) {
    }
    ...
    @Override
    public CoreTextTrack getComponent() {
        return ((CoreTextTrack) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreTextTrackPart component = ((CoreTextTrackPart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getLabelOption(), component::setLabel);
        applicator.add(options.getKindOption(), component::setKind);
        applicator.add(options.getLanguageOption(), component::setLanguage);
        applicator.add(options.getModeOption(), component::setMode);
        applicator.add(options.getCuesOption(), component::setCues);
    }
