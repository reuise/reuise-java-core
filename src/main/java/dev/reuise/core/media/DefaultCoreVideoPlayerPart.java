...
public abstract class DefaultCoreVideoPlayerPart<S extends DefaultCoreVideoPlayerPart<S, O>, O extends CoreVideoPlayerPartOptions> implements ComponentPart , CoreVideoPlayer {
    private CoreMediaPlayerPart mediaPlayerPart;

    private CoreParentComponentPart parentComponentPart;

    private CoreBaseComponentPart baseComponentPart;

    protected DefaultCoreVideoPlayerPart(O options) {
    }
    ...
    public void insertBefore(CoreComponent child, CoreComponent beforeChild) {
        mediaPlayerPart.insertBefore(child, beforeChild);
    }

    @Override
    public S addText(String text) {
        mediaPlayerPart.addText(text);
        return self();
    }

    @Override
    public void remove(CoreComponent child) {
        mediaPlayerPart.remove(child);
    }

    @Override
    public void removeAll() {
        mediaPlayerPart.removeAll();
    }
    ...
    @Override
    public CoreVideoPlayer getComponent() {
        return ((CoreVideoPlayer) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreVideoPlayerPart component = ((CoreVideoPlayerPart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getPosterOption(), component::setPoster);
    }
