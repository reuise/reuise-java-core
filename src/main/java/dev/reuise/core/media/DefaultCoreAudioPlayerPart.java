...
public abstract class DefaultCoreAudioPlayerPart<S extends DefaultCoreAudioPlayerPart<S, O>, O extends CoreAudioPlayerPartOptions> implements ComponentPart , CoreAudioPlayer {
    ...
    protected DefaultCoreAudioPlayerPart(O options) {
    }
    ...
    @Override
    public CoreAudioPlayer getComponent() {
        return ((CoreAudioPlayer) (baseComponentPart.getComponent()));
    }
