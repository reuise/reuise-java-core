...
public abstract class DefaultCoreMediaPlayerPart<S extends DefaultCoreMediaPlayerPart<S, O>, O extends CoreMediaPlayerPartOptions> implements ComponentPart , CoreMediaPlayer {
    ...
    @Override
    public CoreMediaPlayer getComponent() {
        return ((CoreMediaPlayer) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        ...
        applicator.add(options.getAutoplayOption(), component::setAutoplay);
        applicator.add(options.getControlsOption(), component::setControls);
        applicator.add(options.getLoopOption(), component::setLoop);
        applicator.add(options.getMutedOption(), component::setMuted);
        applicator.add(options.getUrlOption(), component::setUrl);
        applicator.add(options.getTextTracksOption(), component::setTextTracks);
    }
