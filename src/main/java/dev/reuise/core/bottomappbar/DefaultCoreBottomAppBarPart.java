...
public abstract class DefaultCoreBottomAppBarPart<S extends DefaultCoreBottomAppBarPart<S, O>, O extends CoreBottomAppBarPartOptions> implements ComponentPart , CoreBottomAppBar {
    private CoreBaseComponentPart baseComponentPart;

    protected DefaultCoreBottomAppBarPart(O options) {
    }
    ...
    @Override
    public CoreBottomAppBar getComponent() {
        return ((CoreBottomAppBar) (baseComponentPart.getComponent()));
    }
