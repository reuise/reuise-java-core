...
public abstract class DefaultCoreImagePart<S extends DefaultCoreImagePart<S, O>, O extends CoreImagePartOptions> implements ComponentPart , CoreImage {
    ...
    @Override
    public CoreImage getComponent() {
        return ((CoreImage) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreImagePart component = ((CoreImagePart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getUrlOption(), component::setUrl);
        applicator.add(options.getSpriteOptionsOption(), component::setSpriteOptions);
