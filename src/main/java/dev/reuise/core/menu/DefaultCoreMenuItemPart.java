...
public abstract class DefaultCoreMenuItemPart<S extends DefaultCoreMenuItemPart<S, O>, O extends CoreMenuItemPartOptions> implements ComponentPart , CoreMenuItem {
    ...
    public void remove(CoreComponent child) {
        listItemPart.remove(child);
    }

    @Override
    public void removeAll() {
        listItemPart.removeAll();
    }
    ...
    @Override
    public CoreMenuItem getComponent() {
        return ((CoreMenuItem) (baseComponentPart.getComponent()));
    }
