...
public abstract class DefaultCoreMenuDividerPart<S extends DefaultCoreMenuDividerPart<S, O>, O extends CoreMenuDividerPartOptions> implements ComponentPart , CoreMenuDivider {
    private CoreMenuItemPart menuItemPart;

    private CoreListItemPart listItemPart;
    ...
    private CoreContainer textContainer;

    private CoreInlineText labelContainer;

    private CoreInlineText secondaryLabelContainer;
    ...
    public void remove(CoreComponent child) {
        menuItemPart.remove(child);
    }

    @Override
    public void removeAll() {
        menuItemPart.removeAll();
    }
    ...
    @Override
    public CoreMenuDivider getComponent() {
        return ((CoreMenuDivider) (baseComponentPart.getComponent()));
    }
