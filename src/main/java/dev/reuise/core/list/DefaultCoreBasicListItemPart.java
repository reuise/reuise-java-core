...
public abstract class DefaultCoreBasicListItemPart<S extends DefaultCoreBasicListItemPart<S, O>, O extends CoreBasicListItemPartOptions> implements ComponentPart , CoreBasicListItem {
    ...
    protected DefaultCoreBasicListItemPart(O options) {
    }
    ...
    @Override
    public CoreBasicListItem getComponent() {
        return ((CoreBasicListItem) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreBasicListItemPart component = ((CoreBasicListItemPart) (options.getComponent()));
        if (component == null)
