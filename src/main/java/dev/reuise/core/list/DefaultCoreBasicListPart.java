...
public abstract class DefaultCoreBasicListPart<S extends DefaultCoreBasicListPart<S, O>, O extends CoreBasicListPartOptions> implements CoreBasicList , ComponentPart {
    @Override
    ...
    protected DefaultCoreBasicListPart(O options) {
    }
    ...
    @Override
    public CoreBasicList getComponent() {
        return ((CoreBasicList) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreBasicListPart component = ((CoreBasicListPart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getItemsOption(), component::setItems);
        applicator.add(options.getOrderedOption(), component::setOrdered);
    }
