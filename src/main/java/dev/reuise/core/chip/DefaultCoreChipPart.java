...
public abstract class DefaultCoreChipPart<S extends DefaultCoreChipPart<S, O>, O extends CoreChipPartOptions> implements ComponentPart , CoreChip {
    @Override
    ...
    protected DefaultCoreChipPart(O options) {
    }
    ...
    @Override
    public CoreChip getComponent() {
        return ((CoreChip) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreChipPart component = ((CoreChipPart) (options.getComponent()));
        if (component == null)
