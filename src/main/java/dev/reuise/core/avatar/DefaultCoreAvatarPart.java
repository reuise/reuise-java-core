...
public abstract class DefaultCoreAvatarPart<S extends DefaultCoreAvatarPart<S, O>, O extends CoreAvatarPartOptions> implements ComponentPart , CoreAvatar {
    @Override
    ...
    @Override
    public S setShape(AvatarShape variant) {
        return self();
    }
    ...
    protected DefaultCoreAvatarPart(O options) {
    }
    ...
    @Override
    public CoreAvatar getComponent() {
        return ((CoreAvatar) (baseComponentPart.getComponent()));
    }
    ...
    private CoreImage createImage(O options) {
        ...
        CoreImageOptions imageOptions = options.getImageOptions();
        if (imageOptions == null)
            return image;

        imageOptions.setParent(this);
        ...
        getParentComponentPart().add(image);
        return image;
    }
    ...
    private CoreBadge createBadge(O options) {
        ...
        getParentComponentPart().add(badge);
        return badge;
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreAvatarPart component = ((CoreAvatarPart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getUrlOption(), component::setUrl);
        applicator.add(options.getDisplayNameOption(), component::setDisplayName);
        applicator.add(options.getSizeOption(), component::setSize);
        applicator.add(options.getShapeOption(), component::setShape);
