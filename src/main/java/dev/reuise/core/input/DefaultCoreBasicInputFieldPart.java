...
public abstract class DefaultCoreBasicInputFieldPart<S extends DefaultCoreBasicInputFieldPart<S, O>, O extends CoreBasicInputFieldPartOptions> implements ComponentPart , CoreBasicInputField {
    @Override
    ...
    protected List<InputValidator> validators;

    protected DefaultCoreBasicInputFieldPart(O options) {
    }
    ...
    @Override
    public CoreBasicInputField getComponent() {
        return ((CoreBasicInputField) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreBasicInputFieldPart component = ((CoreBasicInputFieldPart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getValueOption(), component::setValue);
        applicator.add(options.getPlaceholderOption(), component::setPlaceholder);
        applicator.add(options.getPatternOption(), component::setPattern);
        applicator.add(options.getMultilineOption(), component::setMultiline);
        applicator.add(options.getMinLinesOption(), component::setMinLines);
        applicator.add(options.getMaxLinesOption(), component::setMaxLines);
        applicator.add(options.getReadOnlyOption(), component::setReadOnly);
        applicator.add(options.getAutocompleteOption(), component::setAutocomplete);
        applicator.add(options.getValidatorsOption(), component::setValidators);
        applicator.add(options.getRequiredOption(), component::setRequired);
    ...
    public S setValidators(List<InputValidator> validators) {
        // Create copy of
        this.validators = new ArrayList<InputValidator>(validators);
        return self();
    }
