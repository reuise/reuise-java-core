...
public abstract class DefaultCoreSearchFieldPart<S extends DefaultCoreSearchFieldPart<S, O>, O extends CoreSearchFieldPartOptions> implements ComponentPart , CoreSearchField {
    ...
    protected DefaultCoreSearchFieldPart(O options) {
    }
    ...
    @Override
    public CoreSearchField getComponent() {
        return ((CoreSearchField) (baseComponentPart.getComponent()));
    }
