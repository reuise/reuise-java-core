...
public abstract class AbstractCorePasswordFieldOptions<S extends AbstractCorePasswordFieldOptions<S>> implements CorePasswordFieldOptions , CoreComponentOptions {
    ...
    protected AbstractCorePasswordFieldOptions() {
    }
    ...
    public boolean onPreInitialize() {
        ...
        setDefaultPasswordMode(PasswordMode.CURRENT_PASSWORD);
        return true;
    }
    ...
    public PasswordMode getPasswordMode() {
        return ((PasswordMode) (getOptionValue("passwordMode")));
    }

    @Override
    public ComponentOption<PasswordMode> getPasswordModeOption() {
        return ((ComponentOption<PasswordMode>) (getOption("passwordMode")));
    }

    @Override
    public S setPasswordMode(PasswordMode passwordMode) {
        setOption("passwordMode", passwordMode);
        return self();
    }

    private void setDefaultPasswordMode(PasswordMode passwordMode) {
        setDefaultOption("passwordMode", passwordMode);
    }
