...
public abstract class DefaultCorePasswordFieldPart<S extends DefaultCorePasswordFieldPart<S, O>, O extends CorePasswordFieldPartOptions> implements ComponentPart , CorePasswordField {
    @Override
    ...
    protected DefaultCorePasswordFieldPart(O options) {
    }
    ...
    @Override
    public CorePasswordField getComponent() {
        return ((CorePasswordField) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CorePasswordFieldPart component = ((CorePasswordFieldPart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getPasswordModeOption(), component::setPasswordMode);
    }
