...
public abstract class DefaultCoreColumnLayoutPart<S extends DefaultCoreColumnLayoutPart<S, O>, O extends CoreColumnLayoutPartOptions> implements CoreColumnLayout , ComponentPart {
    ...
    protected DefaultCoreColumnLayoutPart(O options) {
    }
    ...
    @Override
    public CoreColumnLayout getComponent() {
        return ((CoreColumnLayout) (baseComponentPart.getComponent()));
    }
