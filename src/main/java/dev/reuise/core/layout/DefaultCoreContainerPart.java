...
public abstract class DefaultCoreContainerPart<S extends DefaultCoreContainerPart<S, O>, O extends CoreContainerPartOptions> implements ComponentPart , CoreContainer {
    @Override
    ...
    @Override
    public CoreContainerFeatures setBackdropFilter(BackdropFilter backdropFilter, Object value) {
    ...
    protected DefaultCoreContainerPart(O options) {
    }
    ...
    @Override
    public CoreContainer getComponent() {
        return ((CoreContainer) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreContainerPart component = ((CoreContainerPart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getPaddingOption(), component::setPadding);
        applicator.add(options.getPaddingTopOption(), component::setPaddingTop);
        applicator.add(options.getPaddingRightOption(), component::setPaddingRight);
        applicator.add(options.getPaddingBottomOption(), component::setPaddingBottom);
        applicator.add(options.getPaddingLeftOption(), component::setPaddingLeft);
        applicator.add(options.getPositionOption(), component::setPosition);
        applicator.add(options.getInsetOption(), component::setInset);
        applicator.add(options.getBackdropFilterOption(), component::setBackdropFilter);
        if (states != null)
            states.stream().forEach((State state) -> {
                // Apply options for each (non-default) state
                applicator.add(options.getPaddingOption(state), state, component::setPadding);
                applicator.add(options.getPaddingTopOption(state), state, component::setPaddingTop);
                applicator.add(options.getPaddingRightOption(state), state, component::setPaddingRight);
                applicator.add(options.getPaddingBottomOption(state), state, component::setPaddingBottom);
                applicator.add(options.getPaddingLeftOption(state), state, component::setPaddingLeft);
                applicator.add(options.getPositionOption(state), state, component::setPosition);
                applicator.add(options.getInsetOption(state), state, component::setInset);
                applicator.add(options.getBackdropFilterOption(state), state, component::setBackdropFilter);
            });
