...
public abstract class DefaultCoreRowLayoutPart<S extends DefaultCoreRowLayoutPart<S, O>, O extends CoreRowLayoutPartOptions> implements ComponentPart , CoreRowLayout {
    ...
    protected DefaultCoreRowLayoutPart(O options) {
    }
    ...
    @Override
    public CoreRowLayout getComponent() {
        return ((CoreRowLayout) (baseComponentPart.getComponent()));
    }
