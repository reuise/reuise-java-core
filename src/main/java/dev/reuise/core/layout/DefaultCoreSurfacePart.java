...
public abstract class DefaultCoreSurfacePart<S extends DefaultCoreSurfacePart<S, O>, O extends CoreSurfacePartOptions> implements ComponentPart , CoreSurface {
    ...
    protected DefaultCoreSurfacePart(O options) {
    }
    ...
    public void insertBefore(CoreComponent child, CoreComponent beforeChild) {
        flexContainerPart.insertBefore(child, beforeChild);
    }

    @Override
    public S addText(String text) {
        flexContainerPart.addText(text);
        return self();
    }

    @Override
    public void remove(CoreComponent child) {
        flexContainerPart.remove(child);
    }

    @Override
    public void removeAll() {
        flexContainerPart.removeAll();
    }
    ...
    @Override
    public CoreSurface getComponent() {
        return ((CoreSurface) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreSurfacePart component = ((CoreSurfacePart) (options.getComponent()));
        if (component == null)
