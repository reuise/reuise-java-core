...
public abstract class DefaultCoreFieldSetPart<S extends DefaultCoreFieldSetPart<S, O>, O extends CoreFieldSetPartOptions> implements ComponentPart , CoreFieldSet {
    ...
    protected DefaultCoreFieldSetPart(O options) {
    }
    ...
    @Override
    public CoreFieldSet getComponent() {
        return ((CoreFieldSet) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreFieldSetPart component = ((CoreFieldSetPart) (options.getComponent()));
        if (component == null)
