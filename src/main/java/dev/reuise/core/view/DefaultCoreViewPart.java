...
public abstract class DefaultCoreViewPart<S extends DefaultCoreViewPart<S, O>, O extends CoreViewPartOptions> implements ComponentPart , CoreView {
    ...
    protected DefaultCoreViewPart(O options) {
    }
    ...
    @Override
    public CoreView getComponent() {
        return ((CoreView) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreViewPart component = ((CoreViewPart) (options.getComponent()));
        if (component == null)
