...
public abstract class DefaultCoreBasicCheckboxPart<S extends DefaultCoreBasicCheckboxPart<S, O>, O extends CoreBasicCheckboxPartOptions> implements ComponentPart , CoreBasicCheckbox {
    @Override
    ...
    protected DefaultCoreBasicCheckboxPart(O options) {
    }
    ...
    @Override
    public CoreBasicCheckbox getComponent() {
        return ((CoreBasicCheckbox) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreBasicCheckboxPart component = ((CoreBasicCheckboxPart) (options.getComponent()));
        if (component == null)
