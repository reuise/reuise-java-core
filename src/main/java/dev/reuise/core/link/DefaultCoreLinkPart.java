...
public abstract class DefaultCoreLinkPart<S extends DefaultCoreLinkPart<S, O>, O extends CoreLinkPartOptions> implements ComponentPart , CoreLink {
    private CoreParentComponentPart parentComponentPart;

    private CoreBaseComponentPart baseComponentPart;

    protected DefaultCoreLinkPart(O options) {
    }
    ...
    @Override
    public CoreLink getComponent() {
        return ((CoreLink) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreLinkPart component = ((CoreLinkPart) (options.getComponent()));
        if (component == null)
