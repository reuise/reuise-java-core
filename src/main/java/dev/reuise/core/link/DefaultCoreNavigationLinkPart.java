...
public abstract class DefaultCoreNavigationLinkPart<S extends DefaultCoreNavigationLinkPart<S, O>, O extends CoreNavigationLinkPartOptions> implements ComponentPart , CoreNavigationLink {
    private CoreLinkPart linkPart;

    private CoreParentComponentPart parentComponentPart;

    private CoreBaseComponentPart baseComponentPart;

    protected DefaultCoreNavigationLinkPart(O options) {
    }
    ...
    @Override
    public CoreNavigationLink getComponent() {
        return ((CoreNavigationLink) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreNavigationLinkPart component = ((CoreNavigationLinkPart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getActiveOption(), component::setActive);
    }
