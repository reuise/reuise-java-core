...
public abstract class DefaultCoreBadgePart<S extends DefaultCoreBadgePart<S, O>, O extends CoreBadgePartOptions> implements ComponentPart , CoreBadge {
    @Override
    ...
    protected DefaultCoreBadgePart(O options) {
    }
    ...
    @Override
    public CoreBadge getComponent() {
        return ((CoreBadge) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreBadgePart component = ((CoreBadgePart) (options.getComponent()));
        if (component == null)
