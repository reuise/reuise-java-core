...
public abstract class DefaultCoreDrawerPart<S extends DefaultCoreDrawerPart<S, O>, O extends CoreDrawerPartOptions> implements ComponentPart , CoreDrawer {
    @Override
    ...
    protected Map<State, DrawerPosition> drawerPosition = new HashMap<>();

    protected DefaultCoreDrawerPart(O options) {
    }
    ...
    @Override
    public CoreDrawer getComponent() {
        return ((CoreDrawer) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreDrawerPart component = ((CoreDrawerPart) (options.getComponent()));
        if (component == null)
        ...
        applicator.add(options.getDrawerPositionOption(), component::setDrawerPosition);
        applicator.add(options.getOpenOption(), component::setOpen);
        applicator.add(options.getTransitionDurationOption(), component::setTransitionDuration);
        applicator.add(options.getAppLayoutOption(), component::setAppLayout);
        if (states != null)
            states.stream().forEach((State state) -> {
                ...
                applicator.add(options.getDrawerPositionOption(state), state, component::setDrawerPosition);
            });
    ...
    public S setDrawerPosition(DrawerPosition drawerPosition, State state) {
        this.drawerPosition.put(state, drawerPosition);
        return self();
    }
