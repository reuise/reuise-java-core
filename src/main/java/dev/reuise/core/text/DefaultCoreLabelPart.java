...
public abstract class DefaultCoreLabelPart<S extends DefaultCoreLabelPart<S, O>, O extends CoreLabelPartOptions> implements ComponentPart , CoreLabel {
    private CoreInlineTextPart inlineTextPart;

    private CoreTextPart textPart;

    private CoreParentComponentPart parentComponentPart;

    private CoreBaseComponentPart baseComponentPart;

    protected DefaultCoreLabelPart(O options) {
    }
    ...
    public void remove(CoreComponent child) {
        inlineTextPart.remove(child);
    }

    @Override
    public void removeAll() {
        inlineTextPart.removeAll();
    }
    ...
    @Override
    public CoreLabel getComponent() {
        return ((CoreLabel) (baseComponentPart.getComponent()));
    }
