...
public abstract class DefaultCoreInlineTextPart<S extends DefaultCoreInlineTextPart<S, O>, O extends CoreInlineTextPartOptions> implements ComponentPart , CoreInlineText {
    ...
    protected DefaultCoreInlineTextPart(O options) {
    }
    ...
    @Override
    public CoreInlineText getComponent() {
        return ((CoreInlineText) (baseComponentPart.getComponent()));
    }
