...
public abstract class DefaultCoreIconLabelPart<S extends DefaultCoreIconLabelPart<S, O>, O extends CoreIconLabelPartOptions> implements CoreIconLabel , ComponentPart {
    ...
    @Override
    public CoreIconLabel getComponent() {
        return ((CoreIconLabel) (baseComponentPart.getComponent()));
    }
    ...
    private CoreIcon createStartIcon(O options) {
        ...
        startIconOptions.setParent(link != null ? link : this);
    ...
    private CoreIcon createEndIcon(O options) {
        ...
        CoreParentComponentPart parent = (link != null) ? link : getParentComponentPart();
        endIconOptions.setParent(link != null ? link : this);
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreIconLabelPart component = ((CoreIconLabelPart) (options.getComponent()));
        if (component == null)
