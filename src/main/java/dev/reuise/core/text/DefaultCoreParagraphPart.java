...
public abstract class DefaultCoreParagraphPart<S extends DefaultCoreParagraphPart<S, O>, O extends CoreParagraphPartOptions> implements ComponentPart , CoreParagraph {
    @Override
    ...
    @Override
    public CoreParagraph getComponent() {
        return ((CoreParagraph) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreParagraphPart component = ((CoreParagraphPart) (options.getComponent()));
        if (component == null)
