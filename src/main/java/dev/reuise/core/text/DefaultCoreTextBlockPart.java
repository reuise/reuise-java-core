...
public abstract class DefaultCoreTextBlockPart<S extends DefaultCoreTextBlockPart<S, O>, O extends CoreTextBlockPartOptions> implements ComponentPart , CoreTextBlock {
    ...
    protected DefaultCoreTextBlockPart(O options) {
    }
    ...
    @Override
    public CoreTextBlock getComponent() {
        return ((CoreTextBlock) (baseComponentPart.getComponent()));
    }
