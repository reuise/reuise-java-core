...
public abstract class DefaultCoreHeadingPart<S extends DefaultCoreHeadingPart<S, O>, O extends CoreHeadingPartOptions> implements ComponentPart , CoreHeading {
    ...
    @Override
    public CoreHeading getComponent() {
        return ((CoreHeading) (baseComponentPart.getComponent()));
    }
