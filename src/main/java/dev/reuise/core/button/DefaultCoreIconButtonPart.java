...
public abstract class DefaultCoreIconButtonPart<S extends DefaultCoreIconButtonPart<S, O>, O extends CoreIconButtonPartOptions> implements ComponentPart , CoreIconButton {
    ...
    protected DefaultCoreIconButtonPart(O options) {
    }
    ...
    @Override
    public CoreIconButton getComponent() {
        return ((CoreIconButton) (baseComponentPart.getComponent()));
    }
    ...
    private CoreIcon createIcon(O options) {
        ...
        getParentComponentPart().add(icon);
        return icon;
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreIconButtonPart component = ((CoreIconButtonPart) (options.getComponent()));
        if (component == null)
