...
public abstract class DefaultCoreButtonPart<S extends DefaultCoreButtonPart<S, O>, O extends CoreButtonPartOptions> implements ComponentPart , CoreButton {
    ...
    @Override
    public CoreButton getComponent() {
        return ((CoreButton) (baseComponentPart.getComponent()));
    }
    ...
    private CoreIcon createStartIcon(O options) {
        ...
        startIconOptions.setParent(this);
        ...
        getParentComponentPart().add(startIcon);
        return startIcon;
    }
    ...
    private CoreIcon createEndIcon(O options) {
        ...
        getParentComponentPart().add(endIcon);
        return endIcon;
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreButtonPart component = ((CoreButtonPart) (options.getComponent()));
        if (component == null)
    ...
    // Implementation
    public boolean isType(ButtonType type) {
