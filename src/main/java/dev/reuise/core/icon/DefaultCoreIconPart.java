...
public abstract class DefaultCoreIconPart<S extends DefaultCoreIconPart<S, O>, O extends CoreIconPartOptions> implements ComponentPart , CoreIcon {
    @Override
    ...
    @Override
    public CoreIcon getComponent() {
        return ((CoreIcon) (baseComponentPart.getComponent()));
    }
    ...
    private CoreImage createImage(O options) {
        ...
        imageOptions.setParent(link != null ? link : this);
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreIconPart component = ((CoreIconPart) (options.getComponent()));
        if (component == null)
