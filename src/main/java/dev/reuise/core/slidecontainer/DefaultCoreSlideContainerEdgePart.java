...
public abstract class DefaultCoreSlideContainerEdgePart<S extends DefaultCoreSlideContainerEdgePart<S, O>, O extends CoreSlideContainerEdgePartOptions> implements ComponentPart , CoreSlideContainerEdge {
    private CoreParentComponentPart parentComponentPart;

    private CoreBaseComponentPart baseComponentPart;

    protected DefaultCoreSlideContainerEdgePart(O options) {
    }
    ...
    @Override
    public CoreSlideContainerEdge getComponent() {
        return ((CoreSlideContainerEdge) (baseComponentPart.getComponent()));
    }
