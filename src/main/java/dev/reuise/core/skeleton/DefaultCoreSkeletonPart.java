...
public abstract class DefaultCoreSkeletonPart<S extends DefaultCoreSkeletonPart<S, O>, O extends CoreSkeletonPartOptions> implements ComponentPart , CoreSkeleton {
    private CoreBaseComponentPart baseComponentPart;

    protected DefaultCoreSkeletonPart(O options) {
    }
    ...
    @Override
    public CoreSkeleton getComponent() {
        return ((CoreSkeleton) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreSkeletonPart component = ((CoreSkeletonPart) (options.getComponent()));
        if (component == null)
