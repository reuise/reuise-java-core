...
public abstract class DefaultCoreScrollableContainerEdgePart<S extends DefaultCoreScrollableContainerEdgePart<S, O>, O extends CoreScrollableContainerEdgePartOptions> implements ComponentPart , CoreScrollableContainerEdge {
    private CoreParentComponentPart parentComponentPart;

    private CoreBaseComponentPart baseComponentPart;

    protected DefaultCoreScrollableContainerEdgePart(O options) {
    }
    ...
    @Override
    public CoreScrollableContainerEdge getComponent() {
        return ((CoreScrollableContainerEdge) (baseComponentPart.getComponent()));
    }
