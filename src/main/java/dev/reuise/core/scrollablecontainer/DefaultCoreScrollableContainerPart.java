...
public abstract class DefaultCoreScrollableContainerPart<S extends DefaultCoreScrollableContainerPart<S, O>, O extends CoreScrollableContainerPartOptions> implements ComponentPart , CoreScrollableContainer {
    ...
    protected CoreContainer scrollAreaBefore;

    protected CoreScrollableContainerScrollArea scrollArea;

    protected CoreContainer scrollAreaAfter;

    protected ScrollableContainerFadeOptions scrollAreaFadeOptions;

    protected ScrollableContainerScrollButtonOptions scrollButtonOptions;

    protected ScrollableContainerScrollBehavior scrollBehavior;

    protected DefaultCoreScrollableContainerPart(O options) {
    }
    ...
    @Override
    public CoreScrollableContainer getComponent() {
        return ((CoreScrollableContainer) (baseComponentPart.getComponent()));
    }

    public boolean onPreInitialize(O options) {
        // Layout children
        scrollAreaBefore = createScrollAreaBefore(options);
        scrollArea = createScrollArea(options);
        scrollAreaAfter = createScrollAreaAfter(options);
        setupReferences();
        return true;
    }

    public CoreContainer getScrollAreaBefore() {
        return scrollAreaBefore;
    }
    ...
    private CoreContainer createScrollAreaBefore(O options) {
        if ((scrollAreaBefore != null) || (options == null))
            return scrollAreaBefore;

        CoreContainerOptions scrollAreaBeforeOptions = options.getScrollAreaBeforeOptions();
        if (scrollAreaBeforeOptions == null)
            return scrollAreaBefore;

        scrollAreaBeforeOptions.setParent(this);
        ComponentCreator scrollAreaBeforeCreator = options.getScrollAreaBeforeCreator();
        scrollAreaBefore = (scrollAreaBeforeCreator != null) ? ((CoreContainer) (scrollAreaBeforeCreator.create(scrollAreaBeforeOptions))) : getComponentFactory().createContainer(scrollAreaBeforeOptions);
        getParentComponentPart().add(scrollAreaBefore);
        return scrollAreaBefore;
    }

    public CoreScrollableContainerScrollArea getScrollArea() {
        return scrollArea;
    }
    ...
    private CoreScrollableContainerScrollArea createScrollArea(O options) {
        if ((scrollArea != null) || (options == null))
            return scrollArea;

        CoreScrollableContainerScrollAreaOptions scrollAreaOptions = options.getScrollAreaOptions();
        if (scrollAreaOptions == null)
            return scrollArea;

        scrollAreaOptions.setParent(this);
        ComponentCreator scrollAreaCreator = options.getScrollAreaCreator();
        scrollArea = (scrollAreaCreator != null) ? ((CoreScrollableContainerScrollArea) (scrollAreaCreator.create(scrollAreaOptions))) : getComponentFactory().createScrollableContainerScrollArea(scrollAreaOptions);
        getParentComponentPart().add(scrollArea);
        return scrollArea;
    }
    ...
    public List<CoreComponent> getChildren() {
        return scrollArea.getChildren();
    }

    public CoreContainer getScrollAreaAfter() {
        return scrollAreaAfter;
    }
    ...
    private CoreContainer createScrollAreaAfter(O options) {
        if ((scrollAreaAfter != null) || (options == null))
            return scrollAreaAfter;

        CoreContainerOptions scrollAreaAfterOptions = options.getScrollAreaAfterOptions();
        if (scrollAreaAfterOptions == null)
            return scrollAreaAfter;

        scrollAreaAfterOptions.setParent(this);
        ComponentCreator scrollAreaAfterCreator = options.getScrollAreaAfterCreator();
        scrollAreaAfter = (scrollAreaAfterCreator != null) ? ((CoreContainer) (scrollAreaAfterCreator.create(scrollAreaAfterOptions))) : getComponentFactory().createContainer(scrollAreaAfterOptions);
        getParentComponentPart().add(scrollAreaAfter);
        return scrollAreaAfter;
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreScrollableContainerPart component = ((CoreScrollableContainerPart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getScrollDirectionOption(), component::setScrollDirection);
        applicator.add(options.getShowScrollBarsOption(), component::setShowScrollBars);
        applicator.add(options.getScrollAreaFadeOptionsOption(), component::setScrollAreaFadeOptions);
        applicator.add(options.getScrollAreaBorderRadiusOption(), component::setScrollAreaBorderRadius);
        applicator.add(options.getScrollAreaFillColorOption(), component::setScrollAreaFillColor);
        applicator.add(options.getScrollButtonOptionsOption(), component::setScrollButtonOptions);
        applicator.add(options.getScrollBehaviorOption(), component::setScrollBehavior);
    }
    ...
    public S setScrollDirection(ScrollDirection scrollDirection) {
        if (scrollArea != null)
            scrollArea.setScrollDirection(scrollDirection);
    ...
    public ScrollDirection getScrollDirection() {
        ...
        return scrollArea.getScrollDirection();
    }

    public S setScrollAreaFillColor(String scrollAreaFillColor) {
        if (scrollArea != null)
            scrollArea.setFillColor(scrollAreaFillColor);
    ...
    public String getScrollAreaFillColor() {
        ...
        return scrollArea.getFillColor();
    }

    public S setScrollAreaBorderRadius(Integer scrollAreaBorderRadius) {
        if (scrollArea != null)
            scrollArea.setBorderRadius(scrollAreaBorderRadius);
    ...
    public Integer getScrollAreaBorderRadius() {
        ...
        return scrollArea.getBorderRadius();
    }
    ...
    public void scroll(double xCoord, double yCoord) {
    }

    public void scrollToEnd(Axis direction) {
    }
}