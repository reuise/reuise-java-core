...
public abstract class DefaultCoreDropZonePart<S extends DefaultCoreDropZonePart<S, O>, O extends CoreDropZonePartOptions> implements ComponentPart , CoreDropZone {
    private CoreParentComponentPart parentComponentPart;

    private CoreBaseComponentPart baseComponentPart;

    protected DefaultCoreDropZonePart(O options) {
    }
    ...
    @Override
    public CoreDropZone getComponent() {
        return ((CoreDropZone) (baseComponentPart.getComponent()));
    }
