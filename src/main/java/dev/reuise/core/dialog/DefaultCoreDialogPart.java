...
public abstract class DefaultCoreDialogPart<S extends DefaultCoreDialogPart<S, O>, O extends CoreDialogPartOptions> implements ComponentPart , CoreDialog {
    @Override
    ...
    @Override
    public CoreDialogPart setSize(DialogSize size, State state) {
        return self();
    }
    ...
    protected CoreContainer header;

    protected CoreHeading titleHeading;

    protected CoreFlexContainer body;

    protected CoreFlexContainer footer;

    protected CoreContainer scrim;

    protected CoreButton acceptButton;

    protected CoreButton cancelButton;

    protected Boolean open;

    protected Boolean removeOnClose;

    protected Boolean hasAcceptButton;

    protected Boolean hasCancelButton;

    protected DefaultCoreDialogPart(O options) {
    }
    ...
    @Override
    public CoreDialog getComponent() {
        return ((CoreDialog) (baseComponentPart.getComponent()));
    }
    ...
    public boolean onPreInitialize(O options) {
        ...
        titleHeading = createTitleHeading(options);
        body = createBody(options);
        footer = createFooter(options);
        scrim = createScrim(options);
        if (needsAcceptButton(options)) {
            acceptButton = createAcceptButton(options);
        }
        if (needsCancelButton(options)) {
            cancelButton = createCancelButton(options);
        }
        setupReferences();
        return true;
    }
    ...
    public CoreContainer getHeader() {
        return header;
    }
    ...
    private CoreContainer createHeader(O options) {
        if ((header != null) || (options == null))
            return header;

        CoreContainerOptions headerOptions = options.getHeaderOptions();
        if (headerOptions == null)
            return header;

        CoreParentComponentPart parent = (container != null) ? container : getParentComponentPart();
        headerOptions.setParent(container != null ? container : this);
        ComponentCreator headerCreator = options.getHeaderCreator();
        header = (headerCreator != null) ? ((CoreContainer) (headerCreator.create(headerOptions))) : getComponentFactory().createContainer(headerOptions);
        parent.add(header);
        return header;
    }

    public CoreHeading getTitleHeading() {
        return titleHeading;
    }
    ...
    private CoreHeading createTitleHeading(O options) {
        if ((titleHeading != null) || (options == null))
            return titleHeading;

        CoreHeadingOptions titleHeadingOptions = options.getTitleHeadingOptions();
        if (titleHeadingOptions == null)
            return titleHeading;

        CoreParentComponentPart parent = (header != null) ? header : getParentComponentPart();
        titleHeadingOptions.setParent(header != null ? header : this);
        ComponentCreator titleHeadingCreator = options.getTitleHeadingCreator();
        titleHeading = (titleHeadingCreator != null) ? ((CoreHeading) (titleHeadingCreator.create(titleHeadingOptions))) : getComponentFactory().createHeading(titleHeadingOptions);
        parent.add(titleHeading);
        return titleHeading;
    }

    public CoreFlexContainer getBody() {
        return body;
    }
    ...
    private CoreFlexContainer createBody(O options) {
        if ((body != null) || (options == null))
            return body;

        CoreFlexContainerOptions bodyOptions = options.getBodyOptions();
        if (bodyOptions == null)
            return body;

        CoreParentComponentPart parent = (container != null) ? container : getParentComponentPart();
        bodyOptions.setParent(container != null ? container : this);
        ComponentCreator bodyCreator = options.getBodyCreator();
        body = (bodyCreator != null) ? ((CoreFlexContainer) (bodyCreator.create(bodyOptions))) : getComponentFactory().createFlexContainer(bodyOptions);
        parent.add(body);
        return body;
    }
    ...
    public CoreFlexContainer getFooter() {
        return footer;
    }
    ...
    private CoreFlexContainer createFooter(O options) {
        if ((footer != null) || (options == null))
            return footer;

        CoreFlexContainerOptions footerOptions = options.getFooterOptions();
        if (footerOptions == null)
            return footer;

        CoreParentComponentPart parent = (container != null) ? container : getParentComponentPart();
        footerOptions.setParent(container != null ? container : this);
        ComponentCreator footerCreator = options.getFooterCreator();
        footer = (footerCreator != null) ? ((CoreFlexContainer) (footerCreator.create(footerOptions))) : getComponentFactory().createFlexContainer(footerOptions);
        parent.add(footer);
        return footer;
    }

    public CoreContainer getScrim() {
        return scrim;
    }
    ...
    private CoreContainer createScrim(O options) {
        if ((scrim != null) || (options == null))
            return scrim;

        CoreContainerOptions scrimOptions = options.getScrimOptions();
        if (scrimOptions == null)
            return scrim;

        scrimOptions.setParent(this);
        ComponentCreator scrimCreator = options.getScrimCreator();
        scrim = (scrimCreator != null) ? ((CoreContainer) (scrimCreator.create(scrimOptions))) : getComponentFactory().createContainer(scrimOptions);
        getParentComponentPart().add(scrim);
        return scrim;
    }

    public CoreButton getAcceptButton() {
        return acceptButton;
    }
    ...
    private boolean needsAcceptButton(O options) {
        ...
        if (options.isHasAcceptButton())
            return true;

        return false;
    }

    private CoreButton createAcceptButton(O options) {
        if ((acceptButton != null) || (options == null))
            return acceptButton;

        CoreButtonOptions acceptButtonOptions = options.getAcceptButtonOptions();
        if (acceptButtonOptions == null)
            return acceptButton;

        CoreParentComponentPart parent = (footer != null) ? footer : getParentComponentPart();
        acceptButtonOptions.setParent(footer != null ? footer : this);
        ComponentCreator acceptButtonCreator = options.getAcceptButtonCreator();
        acceptButton = (acceptButtonCreator != null) ? ((CoreButton) (acceptButtonCreator.create(acceptButtonOptions))) : getComponentFactory().createButton(acceptButtonOptions);
        parent.add(acceptButton);
        return acceptButton;
    }
    ...
    private boolean needsCancelButton(O options) {
        ...
        if (options.isHasCancelButton())
            return true;

        return false;
    }

    private CoreButton createCancelButton(O options) {
        if ((cancelButton != null) || (options == null))
            return cancelButton;

        CoreButtonOptions cancelButtonOptions = options.getCancelButtonOptions();
        if (cancelButtonOptions == null)
            return cancelButton;

        CoreParentComponentPart parent = (footer != null) ? footer : getParentComponentPart();
        cancelButtonOptions.setParent(footer != null ? footer : this);
        ComponentCreator cancelButtonCreator = options.getCancelButtonCreator();
        cancelButton = (cancelButtonCreator != null) ? ((CoreButton) (cancelButtonCreator.create(cancelButtonOptions))) : getComponentFactory().createButton(cancelButtonOptions);
    ...
    public void onInitialize(O options) {
        CoreContainer footer = getFooter();
        options.getActions().stream().forEach(b -> {
            footer.add(b);
        });
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreDialogPart component = ((CoreDialogPart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getTitleOption(), component::setTitle);
        applicator.add(options.getOpenOption(), component::setOpen);
        applicator.add(options.getSizeOption(), component::setSize);
        applicator.add(options.getRemoveOnCloseOption(), component::setRemoveOnClose);
        applicator.add(options.getModalOption(), component::setModal);
        applicator.add(options.getActionsOption(), component::setActions);
        applicator.add(options.getHasAcceptButtonOption(), component::setHasAcceptButton);
        applicator.add(options.getHasCancelButtonOption(), component::setHasCancelButton);
        if (states != null)
            states.stream().forEach((State state) -> {
                // Apply options for each (non-default) state
                applicator.add(options.getSizeOption(state), state, component::setSize);
            });
    ...
    public S setScrimBackdropFilter(BackdropFilterSetting scrimBackdropFilter) {
        if (scrim != null)
            scrim.setBackdropFilter(scrimBackdropFilter);

        return self();
    }

    public BackdropFilterSetting getScrimBackdropFilter() {
        if (scrim == null)
            return null;

        return scrim.getBackdropFilter();
    }
    ...
    public boolean isRemoveOnClose() {
        return Boolean.TRUE.equals(removeOnClose);
    }
    ...
    public boolean isHasAcceptButton() {
        return Boolean.TRUE.equals(hasAcceptButton);
    }
    ...
    public boolean isHasCancelButton() {
        return Boolean.TRUE.equals(hasCancelButton);
    }
