...
public abstract class DefaultCoreMessageDialogPart<S extends DefaultCoreMessageDialogPart<S, O>, O extends CoreMessageDialogPartOptions> implements ComponentPart , CoreMessageDialog {
    private CoreDialogPart dialogPart;
    ...
    private CoreContainer header;

    private CoreHeading titleHeading;

    private CoreFlexContainer body;

    private CoreFlexContainer footer;

    private CoreContainer scrim;

    private CoreButton acceptButton;

    private CoreButton cancelButton;

    protected String text;

    protected DefaultCoreMessageDialogPart(O options) {
    }
    ...
    public void remove(CoreComponent child) {
        dialogPart.remove(child);
    }

    @Override
    public void removeAll() {
        dialogPart.removeAll();
    }
    ...
    @Override
    public CoreMessageDialog getComponent() {
        return ((CoreMessageDialog) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreMessageDialogPart component = ((CoreMessageDialogPart) (options.getComponent()));
        if (component == null)
