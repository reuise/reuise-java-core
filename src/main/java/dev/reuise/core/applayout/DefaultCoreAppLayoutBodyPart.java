...
public abstract class DefaultCoreAppLayoutBodyPart<S extends DefaultCoreAppLayoutBodyPart<S, O>, O extends CoreAppLayoutBodyPartOptions> implements ComponentPart , CoreAppLayoutBody {
    ...
    protected DefaultCoreAppLayoutBodyPart(O options) {
    }
    ...
    @Override
    public CoreAppLayoutBody getComponent() {
        return ((CoreAppLayoutBody) (baseComponentPart.getComponent()));
    }
