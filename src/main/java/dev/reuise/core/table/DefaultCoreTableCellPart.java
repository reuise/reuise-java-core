...
public abstract class DefaultCoreTableCellPart<S extends DefaultCoreTableCellPart<S, O>, O extends CoreTableCellPartOptions> implements ComponentPart , CoreTableCell {
    @Override
    ...
    @Override
    public CoreTableCellPart setText(String text) {
        addText(text);
        return self();
    }
    ...
    protected DefaultCoreTableCellPart(O options) {
    }
    ...
    @Override
    public CoreTableCell getComponent() {
        return ((CoreTableCell) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreTableCellPart component = ((CoreTableCellPart) (options.getComponent()));
        if (component == null)
