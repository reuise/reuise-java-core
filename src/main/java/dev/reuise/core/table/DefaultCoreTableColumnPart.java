...
public abstract class DefaultCoreTableColumnPart<S extends DefaultCoreTableColumnPart<S, O>, O extends CoreTableColumnPartOptions> implements ComponentPart , CoreTableColumn {
    private CoreParentComponentPart parentComponentPart;

    private CoreBaseComponentPart baseComponentPart;

    protected CoreMenuOptions menuOptions;

    protected Boolean hasMenuButton;

    protected CoreIconButtonOptions menuButtonOptions;

    protected DefaultCoreTableColumnPart(O options) {
    }
    ...
    @Override
    public CoreTableColumn getComponent() {
        return ((CoreTableColumn) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreTableColumnPart component = ((CoreTableColumnPart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getLabelOption(), component::setLabel);
        applicator.add(options.getMenuOptionsOption(), component::setMenuOptions);
        applicator.add(options.getHasMenuButtonOption(), component::setHasMenuButton);
        applicator.add(options.getMenuButtonOptionsOption(), component::setMenuButtonOptions);
    }
