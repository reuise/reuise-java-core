...
public abstract class DefaultCoreTableColumnGroupPart<S extends DefaultCoreTableColumnGroupPart<S, O>, O extends CoreTableColumnGroupPartOptions> implements CoreTableColumnGroup , ComponentPart {
    @Override
    ...
    public S setColumns(List<CoreTableColumnOptions> columns) {
        if ((isInitialized() || (columns == null)) || columns.isEmpty())
            return self();
    ...
    public S addColumn(CoreTableColumnOptions column) {
        ...
        CoreTableColumnOptions columnOpts = getComponentFactory().createTableColumnOptions();
        columnOpts.setWidth(column.getWidth());
        add(getComponentFactory().createTableColumn(columnOpts));
        return self();
    }
    ...
    protected DefaultCoreTableColumnGroupPart(O options) {
    }
    ...
    @Override
    public CoreTableColumnGroup getComponent() {
        return ((CoreTableColumnGroup) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreTableColumnGroupPart component = ((CoreTableColumnGroupPart) (options.getComponent()));
        if (component == null)
