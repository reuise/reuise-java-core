...
public abstract class DefaultCoreCheckboxTableColumnPart<S extends DefaultCoreCheckboxTableColumnPart<S, O>, O extends CoreCheckboxTableColumnPartOptions> implements ComponentPart , CoreCheckboxTableColumn {
    private CoreTableColumnPart tableColumnPart;
    ...
    protected DefaultCoreCheckboxTableColumnPart(O options) {
    }
    ...
    public void remove(CoreComponent child) {
        tableColumnPart.remove(child);
    }

    @Override
    public void removeAll() {
        tableColumnPart.removeAll();
    }
    ...
    @Override
    public CoreCheckboxTableColumn getComponent() {
        return ((CoreCheckboxTableColumn) (baseComponentPart.getComponent()));
    }
