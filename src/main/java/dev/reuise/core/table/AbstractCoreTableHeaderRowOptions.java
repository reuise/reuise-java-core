...
public abstract class AbstractCoreTableHeaderRowOptions<S extends AbstractCoreTableHeaderRowOptions<S>> implements CoreComponentOptions , CoreTableHeaderRowOptions {
    protected AbstractCoreTableHeaderRowOptions() {
    }
