...
public abstract class DefaultCoreTableBodyPart<S extends DefaultCoreTableBodyPart<S, O>, O extends CoreTableBodyPartOptions> implements ComponentPart , CoreTableBody {
    private CoreParentComponentPart parentComponentPart;

    private CoreBaseComponentPart baseComponentPart;

    protected DefaultCoreTableBodyPart(O options) {
    }
    ...
    @Override
    public CoreTableBody getComponent() {
        return ((CoreTableBody) (baseComponentPart.getComponent()));
    }
