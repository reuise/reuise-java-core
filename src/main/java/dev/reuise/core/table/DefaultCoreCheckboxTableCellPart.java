...
public abstract class DefaultCoreCheckboxTableCellPart<S extends DefaultCoreCheckboxTableCellPart<S, O>, O extends CoreCheckboxTableCellPartOptions> implements ComponentPart , CoreCheckboxTableCell {
    private CoreTableCellPart tableCellPart;
    ...
    protected DefaultCoreCheckboxTableCellPart(O options) {
    }
    ...
    public void remove(CoreComponent child) {
        tableCellPart.remove(child);
    }

    @Override
    public void removeAll() {
        tableCellPart.removeAll();
    }
    ...
    @Override
    public CoreCheckboxTableCell getComponent() {
        return ((CoreCheckboxTableCell) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreCheckboxTableCellPart component = ((CoreCheckboxTableCellPart) (options.getComponent()));
        if (component == null)
