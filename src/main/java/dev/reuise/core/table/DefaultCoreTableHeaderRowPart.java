...
public abstract class DefaultCoreTableHeaderRowPart<S extends DefaultCoreTableHeaderRowPart<S, O>, O extends CoreTableHeaderRowPartOptions> implements ComponentPart , CoreTableHeaderRow {
    @Override
    ...
    protected DefaultCoreTableHeaderRowPart(O options) {
    }
    ...
    @Override
    public CoreTableHeaderRow getComponent() {
        return ((CoreTableHeaderRow) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreTableHeaderRowPart component = ((CoreTableHeaderRowPart) (options.getComponent()));
        if (component == null)
