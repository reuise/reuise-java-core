...
public abstract class DefaultCoreTableFooterPart<S extends DefaultCoreTableFooterPart<S, O>, O extends CoreTableFooterPartOptions> implements ComponentPart , CoreTableFooter {
    @Override
    ...
    protected DefaultCoreTableFooterPart(O options) {
    }
    ...
    @Override
    public CoreTableFooter getComponent() {
        return ((CoreTableFooter) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        CoreTableFooterPart component = ((CoreTableFooterPart) (options.getComponent()));
        if (component == null)
