...
public abstract class DefaultCoreTableRowPart<S extends DefaultCoreTableRowPart<S, O>, O extends CoreTableRowPartOptions> implements ComponentPart , CoreTableRow {
    private CoreParentComponentPart parentComponentPart;

    private CoreBaseComponentPart baseComponentPart;

    protected DefaultCoreTableRowPart(O options) {
    }
    ...
    @Override
    public CoreTableRow getComponent() {
        return ((CoreTableRow) (baseComponentPart.getComponent()));
    }
